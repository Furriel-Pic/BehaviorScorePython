...
Dois pontos importantes a serem considerados no processo de modelagem são a avaliação dos missings e a identificação de outliers. Neste caso, verifica-se que a variável RendaMensal, possui 20% de missings, logo um estudo de imputação de dados pode ser considerado para o prenchimento dos casos faltantes. Acerca disto, meu amigo Victor, tem um artigo bastante interessante em seu blog: https://nagahamavh.github.io/nagahamaVH.github.io/posts/data-understanding-in-data-science/.
